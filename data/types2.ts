...
export interface BaseQuestion {
  id: string;
  type: Question['type'];
  question: Bilingual;  // We gebruiken 'question' in plaats van 'label'
  required: boolean;
  conditional?: Conditional;
}
...
export interface BaseQuestion {
  ...
  required: boolean;
  conditional?: Conditional;
  comment?: Bilingual;  // Add this line
}
...
// New types specific for the dashboard
...
// You might want to add this if you're using it in your component
