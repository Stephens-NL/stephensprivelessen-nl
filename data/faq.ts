...
export const faqItems: FAQItems = [
  ...
  },
  {
    ...
    answer: {
      NL: "Onze bijlessen kunnen zowel online als fysiek plaatsvinden. Voor online lessen gebruiken we tools zoals Google Meet. De lessen worden gepland op basis van de beschikbaarheid van de student en de bijlesgever, met flexibele tijden om aan verschillende schema's te voldoen.",
      EN: "Our tutoring sessions can take place both online and in person. For online lessons, we use Google Meet. The lessons are scheduled based on the availability of the student and the tutor, with flexible times to accommodate different schedules."
    }
  },
  {
    id: 7,
  ...
  },
  {
    ...
    answer: {
      NL: "We maken gebruik van de nieuwste technologieën, waaronder AI-taalmodellen zoals GPT-3, om complexe concepten te verduidelijken en interactieve leerervaringen te bieden. We gebruiken ook een iPad voor digitale aantekeningen, die we na de les delen met de student.",
  ...
  },
  {
    ...
    answer: {
      ...
      EN: "We create a positive and supportive environment where students are encouraged to be curious and discover their passion for learning. We are there to support, but the ultimate motivation depends on the student themselves."
    }
  },
  {
    id: 16,
