...
const content = {
  hero: {
    ...
    description: {
      EN: 'Specialized tutoring services that bridge Ghanaian and Dutch educational systems. €30/hour with experienced tutors who understand your unique needs.',
      NL: 'Gespecialiseerde bijles die Ghanese en Nederlandse onderwijssystemen overbrugt. €30/uur met ervaren docenten die uw unieke behoeften begrijpen.'
    }
  },
  cta: {
    trial: {
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="text-center text-white">
            ...
            <div className="flex flex-col md:flex-row gap-4 justify-center items-center">
              <a 
                href="https://wa.me/31687340641?text=Hi!%20I'm%20interested%20in%20Ghanaian%20tutoring%20services.%20Can%20I%20book%20a%20trial%20lesson?"
                target="_blank"
