...
export default function Error({
  ...
  return (
    <div className="min-h-screen bg-[var(--ink)] flex items-center justify-center px-4">
      <div className="max-w-xl w-full bg-[var(--ink-light)]/80 backdrop-blur-lg rounded-2xl shadow-2xl p-12 text-center text-on-dark">
        ...
        <p className="text-xl text-on-dark/80 mb-8">
