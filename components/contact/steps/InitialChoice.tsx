        ...
        >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <m.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="flex flex-col items-center p-6 bg-ink-light rounded-lg text-amber hover:bg-ink-light transition-colors border-2 border-ink-light hover:border-amber"
