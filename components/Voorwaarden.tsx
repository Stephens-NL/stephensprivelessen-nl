...
export default function Voorwaarden() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-16">
      ...
      <p className="text-lg text-on-dark-muted mb-2">{t("subtitle")}</p>
      <p className="text-on-dark-muted mb-8">{t("intro")}</p>

      <section className="mb-8">
        <h2 className="text-xl font-semibold mb-3">{t("agreement.title")}</h2>
        <ul className="space-y-2 text-on-dark-muted">
      ...
      <section className="mb-8">
        ...
        <p className="text-on-dark-muted mb-2">{t("privacy.description")}</p>
        <p className="text-on-dark-muted mb-2">{t("privacy.rights")}</p>
        <p className="text-on-dark-muted">{t("privacy.contact")}</p>
      </section>

      <section className="mb-8">
        <h2 className="text-xl font-semibold mb-3">{t("pricing.title")}</h2>
        <p className="text-on-dark-muted">{t("pricing.description")}</p>
      </section>

      <div className="mt-12 text-center">
        <p className="text-on-dark-muted mb-4">{t("cta")}</p>
        <Link
          href="/contact"
